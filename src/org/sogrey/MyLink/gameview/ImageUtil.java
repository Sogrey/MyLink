...
public class ImageUtil {
	 ...
	 */
	public static List<BlockImage> getPlayImages(Context context, int size)
	{
		// 获取图片ID组成的集合
		List<Integer> resourceValues = getPlayValues(size);
		List<BlockImage> result = new ArrayList<BlockImage>();
		// 遍历每个图片ID
		for (Integer value : resourceValues)
		{
			...
			// 封装图片ID与图片本身
			BlockImage pieceImage = new BlockImage(bm, value);
